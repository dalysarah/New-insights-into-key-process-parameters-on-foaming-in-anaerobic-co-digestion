...
```{r}
setwd("C:/Users/dalys/OneDrive/Desktop/PHD paper notes/Foam_Github/Table2")
list.files()
...
#T-test of signficance
```{r}
str="EQ" #input section of digester intersted in 
...
write.table(new_df, file = "pvalsfoaming.txt", sep = ",", quote = FALSE, row.names = F)
  ...
  save_kable(x, file=' EQ pvalue.png')
   save_kable(x, file=' EQ pvalue.pdf')
